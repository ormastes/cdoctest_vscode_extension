...
elseif(\"${FRAMEWORK}\" STREQUAL \"gtest\")
  ...
  foreach(_entry IN LISTS _entries)
    ...
    set(_display_name \"\${_suite_name}::\${_test_name}\")
    set(_filter_name \"\${_suite_name}.\${_test_name}\")
    ...
    # Write to CTest file
    file(APPEND \"\${_ctest_file}\" \"add_test(\\\"\${_display_name}\\\" \\\"\${CMAKE_CURRENT_BINARY_DIR}/\${TEST_TARGET}\${CMAKE_EXECUTABLE_SUFFIX}\\\" \\\"--gtest_filter=\${_filter_name}\\\")\\n\")
