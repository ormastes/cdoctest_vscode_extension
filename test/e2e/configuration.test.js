...
setup_1.test.describe('Configuration Management', () => {
    (0, setup_1.test)('should load and apply cdoctest configuration', async ({ page, workspacePath }) => {
        ...
        (0, setup_1.expect)(value).toBe('MyTestConfig');
    });
    (0, setup_1.test)('should handle multiple workspace configurations', async ({ page, workspacePath }) => {
        ...
        fs.writeFileSync(path.join(workspace1, '.vscode', 'settings.json'), JSON.stringify({
        ...
        fs.writeFileSync(path.join(workspace2, '.vscode', 'settings.json'), JSON.stringify({
        ...
        await (0, setup_1.expect)(explorer).toBeVisible();
        ...
        await (0, setup_1.expect)(project1).toBeVisible();
        await (0, setup_1.expect)(project2).toBeVisible();
    });
    (0, setup_1.test)('should validate configuration values', async ({ page }) => {
        // Open settings
        await page.keyboard.press('Control+Shift+P');
        await page.waitForTimeout(500);
  ...
  "cdoctest.resultSuccessRgex": "["
        ...
        (0, setup_1.expect)(problemCount).toBeGreaterThan(0);
    });
});
